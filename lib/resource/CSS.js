...
var proto = {
  ...
  compile: function(map) {
    ...
    //      }
    //
    //      var uri = node_path.join(resource.path, $1);
    //      var inlineResource = map.getResourceByPath(uri);
    //      // 若图片未编译
    //      if (inlineResource) {
    //        !inlineResource.isCompiled && inlineResource.compile();
    //        return $0.replace($1, inlineResource.uri);
    //      } else {
    //        logger.warn('Image [' + $1 + '] in file [' + resource.path + '] Not found');
    //      }
    //
    //      return $0;
    //    });
...
CSS.prototype = Object.create(proto);
