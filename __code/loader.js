/**
 * Created by acemood on 15-10-10.
 */

exports.CSSLoader = require('./loader/CSSLoader');
exports.ImageLoader = require('./loader/ImageLoader');
exports.JSBenchLoader = require('./loader/JSBenchLoader');
exports.JSLoader = require('./loader/JSLoader');
exports.TMPLLoader = require('./loader/TMPLLoader');
exports.JSMockLoader = require('./loader/JSMockLoader');
exports.JSTestLoader = require('./loader/JSTestLoader');
