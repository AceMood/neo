...
describe('Finder', function () {
  ...
  it('should find files in a directory using find method', function (done) {
    var finder = getFinder([workingDir], ['.js'], null, true);
  ...
  it('should find files in a directory using getFinder static method', function (done) {
...
//# sourceMappingURL=Finder-Spec-compiled.js.map