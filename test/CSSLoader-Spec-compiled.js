...
describe('CSSLoader', function () {
  ...
  it('should extract component name', function (done) {
    var loader = new CSSLoader();
    loader.loadFromPath(node_path.join(testData, 'plain.css'), null, function (r) {
  ...
  it('should parse special attributes', function (done) {
    var loader = new CSSLoader();
    loader.loadFromPath(node_path.join(testData, 'special.css'), null, function (r) {
  ...
  it('should extract css sprites', function (done) {
    var loader = new CSSLoader();
    loader.loadFromPath(node_path.join(testData, 'sprite.css'), null, function (r) {
      expect(r.sprites).to.be.a('array');
      expect(r.sprites).to.have.length(2);
      expect(r.sprites).to.deep.equal(['images/dialog/halo_top_left.png', 'images/dialog/large_halo_top_left.png']);
  ...
  it('should resolve module id in postProcess', function (done) {
    var neo = new Neo([new CSSLoader()], [__dirname + '/../__test_data__/Loader'], {
      forceRescan: true
    });
...
//# sourceMappingURL=CSSLoader-Spec-compiled.js.map